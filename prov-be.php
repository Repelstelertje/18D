	...
	<div class="container">
      ...
      <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item" 
        ...
        <div class="card h-100">
            <a :href="'profile.php?country=be&id=' + profile.id"><img class="card-img-top" :src="profile.src.replace('150x150', '300x300')" :alt="profile.name + ' daten in Flevoland'"></a>
            <div class="card-body">
            	<div class="card-top">
            ...
            <a :href="'profile.php?country=be&id=' + profile.id" class="card-footer btn btn-primary">Bekijk profiel</a></div>
        </div>
      </div>
      <script>
